...
const LoginPage: FC = () => {
  ...
  const { isAuthenticated, authError, clearAuthError, loginUser } = useAuth();
  ...
  return (
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <p style={styles.subtitle}>Log in to access your Buckeye Marketplace account.</p>
        ...
        <form style={styles.form} noValidate onSubmit={(event) => void handleSubmit(event)}>
          ...
          <button type="submit" style={styles.submit} disabled={isSubmitting} onClick={handleSubmitClick}>
